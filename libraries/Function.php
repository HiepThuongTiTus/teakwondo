<?php 
    ...
    **/
    ...
    function base_url()
    {
        ...
        return $url  = "http://localhost:8080/teakwondo/"; 
    }
    ...
    if ( ! function_exists('redirectClassA'))
    {
        function redirectClassA($url = "")
        {
            header("location: ".base_url()."class/modules/{$url}");exit();
        }
    }

    if ( ! function_exists('returnGV'))
    {
        function returnGV($url = "")
        {
            header("location: ".base_url()."lopdaiden/{$url}");exit();
        }
    }
